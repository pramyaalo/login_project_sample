...
class FranchiseRefferelIncome extends StatefulWidget {
  const FranchiseRefferelIncome({Key? key}) : super(key: key);

  @override
  _CabsListScreenState createState() => _CabsListScreenState();
}

class _CabsListScreenState extends State<FranchiseRefferelIncome> {
  List<String> months = [
    'January',
    'February',
    'March',
  ...
  static Future<List<FranchiseIncomeReportModel>?> getLabels() async {
    ...
    Future<http.Response>? __futureLabels = ResponseHandler.performPost(
        "GetIncomereport",
        "MemberId=1000000&ReportTypeId=16&Month=07&Year=2021&PageIndex=1");
