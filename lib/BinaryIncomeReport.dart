...
class BinaryIncomeReport extends StatefulWidget {
  const BinaryIncomeReport({Key? key}) : super(key: key);

  @override
  _CabsListScreenState createState() => _CabsListScreenState();
}

class _CabsListScreenState extends State<BinaryIncomeReport> {
