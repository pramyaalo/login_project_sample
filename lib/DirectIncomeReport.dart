...
class DirectIncomeReport extends StatefulWidget {
  const DirectIncomeReport({Key? key}) : super(key: key);

  @override
  _CabsListScreenState createState() => _CabsListScreenState();
}

class _CabsListScreenState extends State<DirectIncomeReport> {
  List<String> months = [
    'January',
    'February',
    'March',
  ...
  static Future<List<FranchiseIncomeReportModel>?> getLabels() async {
    ...
    Future<http.Response>? __futureLabels = ResponseHandler.performPost(
        "GetIncomereport",
        "MemberId=$memberId&ReportTypeId=12&Month=07&Year=2021&PageIndex=1");
