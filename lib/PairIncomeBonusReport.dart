...
import 'package:login_project_sample/Models/PairIncomeBonusModel.dart';
...
class PairIncomeBonusReport extends StatefulWidget {
  const PairIncomeBonusReport({Key? key}) : super(key: key);

  @override
  _CabsListScreenState createState() => _CabsListScreenState();
}

class _CabsListScreenState extends State<PairIncomeBonusReport> {
  List<String> months = [
    'January',
    'February',
    'March',
  ...
  static Future<List<PairIncomeBonusModel>?> getLabels() async {
    String memberId = await Prefs.getStringValue(Prefs.PREFS_USER_ID);
    log("memberId" + memberId);
    List<PairIncomeBonusModel> labelData = [];
    Future<http.Response>? __futureLabels = ResponseHandler.performPost(
        "GetIncomereport",
        "MemberId=$memberId&ReportTypeId=23&Month=07&Year=2021&PageIndex=1");
    ...
    return await __futureLabels.then((value) {
      ...
      try {
        ...
        for (int i = 0; i < decodedJson.length; i++) {
          PairIncomeBonusModel fm =
              PairIncomeBonusModel.fromJson(decodedJson[i]);
          labelData.add(fm);
  ...
  Widget build(BuildContext context) {
    return SafeArea(
        child: Scaffold(
            ...
            body: Center(
                child: FutureBuilder<List<PairIncomeBonusModel>?>(
                    future: getLabels(),
